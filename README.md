...
- secure customer registration, short-lived issuer/audience/type-scoped JWT access tokens, rotating hashed refresh tokens, logout, account-state enforcement, and environment-only administrator bootstrap;
