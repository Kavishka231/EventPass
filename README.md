...
- transactional outbox events with PostgreSQL `SKIP LOCKED` claiming, persisted exponential retry schedules, visible failure states and admin recovery, idempotent notification consumption, and Flyway-managed schema evolution;
