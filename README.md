...
- Redis TTL locks plus PostgreSQL row locks, optimistic versions, server-side pricing, booking/payment idempotency, refunds, cancellation, seat resale, expiration, and cryptographically secure tickets;
