...
- administrator user/role/statistics APIs, venue management, physical seat creation with capacity checks, organizer-owned events, guarded publication/cancellation transitions, and per-event pricing/blocking;
