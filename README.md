...
- administrator user/role/statistics APIs with self-change and last-active-admin protection, venue management, physical seat creation with capacity checks, organizer-owned events, guarded publication/cancellation with immediate ticket invalidation, organizer-owned/admin QR ticket validation and concurrency-safe redemption, automatic booking refunds and inventory release, and per-event pricing/blocking;
