...
- versioned event envelopes, transactional outbox events with PostgreSQL `SKIP LOCKED` claiming, persisted exponential retries, visible failure states and admin recovery, idempotent notification consumption, and Flyway-managed schema evolution;
