...
- administrator user/role/statistics APIs, venue management, physical seat creation with capacity checks, organizer-owned events, guarded publication/cancellation with automatic booking refunds and inventory release, and per-event pricing/blocking;
...
- Java 21 formatting/build CI and PostgreSQL/Redis Testcontainers coverage for seat contention, booking idempotency races, failed payments, provider replay, concurrent cancellation, and duplicate refunds.
