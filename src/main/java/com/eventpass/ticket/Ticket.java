...
public class Ticket {
  ...
  @OneToOne(fetch = FetchType.LAZY, optional = false) private EventSeat eventSeat;
  @Column(name = "qr_token", nullable = false, unique = true, length = 128) private String qrToken;
