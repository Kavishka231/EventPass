...
public class Booking extends BaseEntity {
  ...
  @Column(name = "booking_reference", nullable = false, unique = true) private String bookingReference;
  ...
  @OneToMany(mappedBy = "booking", cascade = CascadeType.ALL, orphanRemoval = true) private List<BookingItem> items = new ArrayList<>();
  public enum Status { PENDING, CONFIRMED, CANCELLED, EXPIRED, FAILED }
}
