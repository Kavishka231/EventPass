...
- Messaging: transactional domain outbox, PostgreSQL `FOR UPDATE SKIP LOCKED` batch claiming for competing publisher instances, retrying Kafka publication, and an idempotent notification consumer backed by `processed_events`.
